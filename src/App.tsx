              ...
              <button
                ...
                onClick={() => {
                  if (canViewPlayerHistory) {
                    onSelectRecipePlayerId(player.id)
                  }
                }}
                title={canViewPlayerHistory ? undefined : 'Buy Market Espionage to see their data.'}
                type="button"
              >
                {player.name}
              </button>
...
function ResultsScreen({
  ...
  useEffect(() => {
    if (
      canViewRecipeHistoryPlayer({
        currentPlayer,
        currentPlayerId,
        targetPlayerId: chartLayout.recipe.selectedPlayerId,
  ...
  }, [chartLayout.recipe.selectedPlayerId, chartPlayers, currentPlayer, currentPlayerId, room.targetPlayerCount])
